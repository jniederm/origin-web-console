...
var O = t("annotation"), U = t("canI"), x = t("buildConfigForBuild"), F = t("deploymentIsInProgress"), M = t("imageObjectRef"), H = t("isJenkinsPipelineStrategy"), q = t("isNewerResource"), z = t("label"), G = t("podTemplate"), W = i.getPreferredVersion("buildconfigs"), K = i.getPreferredVersion("builds"), J = i.getPreferredVersion("appliedclusterresourcequotas"), Q = i.getPreferredVersion("daemonsets"), Y = i.getPreferredVersion("deploymentconfigs"), Z = i.getPreferredVersion("deployments"), X = i.getPreferredVersion("horizontalpodautoscalers"), ee = i.getPreferredVersion("imagestreams"), te = i.getPreferredVersion("limitranges"), ne = i.getPreferredVersion("pods"), re = i.getPreferredVersion("replicasets"), ae = i.getPreferredVersion("replicationcontrollers"), oe = i.getPreferredVersion("resourcequotas"), ie = i.getPreferredVersion("routes"), se = i.getPreferredVersion("servicebindings"), ce = i.getPreferredVersion("clusterserviceclasses"), le = i.getPreferredVersion("serviceinstances"), ue = i.getPreferredVersion("clusterserviceplans"), de = i.getPreferredVersion("services"), pe = i.getPreferredVersion("statefulsets"), me = i.getPreferredVersion("templates");
...
localStorage.setItem(Oe, e), Te(), Ae = "app" === B.viewBy ? [ "metadata.name", "metadata.labels.app" ] : [ "metadata.name" ], Ve(), "pipeline" === B.viewBy ? b.setLabelSuggestions(he) : b.setLabelSuggestions(ve);
...
return "Succeeded" !== e.status.phase && "Failed" !== e.status.phase && (!z(e, "openshift.io/deployer-pod-for.name") && (!O(e, "openshift.io/build.name") && "slave" !== z(e, "jenkins")));
}, rt = function() {
be.podsByOwnerUID = k.groupByOwnerUID(B.pods), B.monopods = _.filter(be.podsByOwnerUID[""], nt), A();
}, at = function(e) {
return !!_.get(e, "status.replicas") || (!O(e, "deploymentConfig") || F(e));
}, ot = function(e) {
...
o && !q(r, o) || (ye[a] = r);
var i;
"Complete" === O(r, "deploymentStatus") && ((i = t[a]) && !q(r, i) || (t[a] = r)), at(r) && _.set(n, [ a, r.metadata.name ], r);
...
poll: L,
pollInterval: 6e4
}))), u.SERVICE_CATALOG_ENABLED && U(se, "watch") && Et.push(p.watch(se, r, function(e) {
...
n.replicationControllers = w(e.by("metadata.name"), !0), n.replicationControllersLoaded = !0, _.each(n.replicationControllers, I), U(), l.log("replicationcontrollers", n.replicationControllers);
...
}), e.replicaSet = t, V(t), U(), z(), e.deployment && F();
...
e.$on("$destroy", T);
var N = i.getPreferredVersion("configmaps"), A = i.getPreferredVersion("limitranges"), B = i.getPreferredVersion("imagestreams"), $ = i.getPreferredVersion("imagestreamtags"), L = i.getPreferredVersion("secrets"), V = i.getPreferredVersion("resourcequotas"), O = i.getPreferredVersion("appliedclusterresourcequotas");
...
controller: [ "$scope", "$filter", "$routeParams", "APIService", "AuthorizationService", "DataService", "ListRowUtils", "Navigate", "ProjectsService", "KubevirtVersions", "VmActions", "moment", "RdpService", function(t, n, r, a, o, i, s, c, l, u, d, p, m) {
function f() {
...
function g(e) {
var n = f();
return n.spec.running = e, i.update(u.virtualMachine.resource, n.metadata.name, n, t.$parent.context);
}
var v = this;
v.KubevirtVersions = u, v.VmActions = d, _.extend(v, s.ui), v.actionsDropdownVisible = function() {
return !_.get(v.apiObject, "metadata.deletionTimestamp") && n("canIDoAny")("virtualMachineInstances");
...
return i.delete(u.virtualMachineInstance, v.apiObject._vm.metadata.name, t.$parent.context);
